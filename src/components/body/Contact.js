                        ...
                        <Form model="feedback" onSubmit={values => this.handleSubmit(values)}>
                            ...
                            <FormGroup row> 
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors className="text-danger" model=".telnum" show="touched" messages={{ required: "Required", isNumber: "Invalid Number"}} />
                                </Col>
                            </FormGroup>
                            <FormGroup row> 
                            ...
                            <FormGroup>
                                ...
                                <Col md={10}>
                                    <Control.textarea model=".message" name="message" className="form-control" validators={{required}}/>
